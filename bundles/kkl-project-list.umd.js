(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('kkl-project-list', ['exports', '@angular/core', '@angular/common/http', '@angular/forms', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["kkl-project-list"] = {}, global.ng.core, global.ng.common.http, global.ng.forms, global.ng.common));
    ...
    var KklProjectListComponent = /** @class */ (function () {
        ...
        KklProjectListComponent.prototype.GetProjects = function () {
    ...
    KklProjectListModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: KklProjectListModule, declarations: [KklProjectListComponent], imports: [i2.ReactiveFormsModule, i2.FormsModule,
            i1.HttpClientModule, i3.CommonModule], exports: [KklProjectListComponent] });
    KklProjectListModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: KklProjectListModule, imports: [[
                i2.ReactiveFormsModule, i2.FormsModule,
                i1.HttpClientModule, i3.CommonModule
            ]] });
